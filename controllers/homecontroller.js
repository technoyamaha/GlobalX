...
function renderWithLayout(res, viewPath, data = {}) {
  ...
  res.render(viewPath, finalData, (err, renderedBody) => {
    if (err) {
      console.error("EJS rendering error:", err);
      return res.status(500).send("Internal Server Error");
    }
...
function landingPage(req, res) {
  renderWithLayout(res, "landing/landingPage", {
    title: "GlobalX A Next Evolution of Digital Intelligence Finance",
    activePage: "landingPage",
    bodyClass: "main-landing-custm-page",
  });
}
